...
public class UploadVideoDemo {
	//账号AK信息请填写(必选)
	private static final String accessKeyId = "LTAIhiyF1bmbVDok";
	//账号AK信息请填写(必选)
	private static final String accessKeySecret = "y2v0iHgOet2NcQVyqpkNQ4J8VYeCht";
	public static void main(String[] args) {
		...
		//文件名必须包含扩展名
		String fileName = "F:\\谷粒学院\\day01\\01视频\\1-1课程计划.mp4";
		//本地文件上传
