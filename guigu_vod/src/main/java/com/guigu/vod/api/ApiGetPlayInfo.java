...
public class ApiGetPlayInfo {
	...
	private static Map<String, String> generatePrivateParamters() {
		...
		// 视频ID
		privateParams.put("VideoId","8e81cc0af6b142fbba9aa3065c859dbc");
		// API名称
	...
	private static String getCQS(List<String> allParams) {
		ApiGetPlayInfo.ParamsComparator paramsComparator = new ApiGetPlayInfo.ParamsComparator();
